...
if __name__=='__main__':
    ...
    if comm.rank==0:
        ...
        plot_data_greens1(event_id+'DMT_waveforms.png',
            data_sw, greens_sw, process_sw, 
            misfit_sw, stations, origin, best_mt, lune_dict)


        plot_beachball(event_id+'DMT_beachball.png',
            best_mt, stations, origin)


        plot_misfit_lune(event_id+'DMT_misfit.png', results)


        print('Saving results...\n')

        # save best-fitting source
        save_json(event_id+'DMT_solution.json', merged_dict)


        # save misfit surface
        results.save(event_id+'DMT_misfit.nc')
