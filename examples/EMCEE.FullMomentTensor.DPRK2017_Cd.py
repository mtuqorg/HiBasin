...
if __name__=='__main__':
    ...
    if comm.rank==0:
        ...
        solver = MCMC_SOLVER(misfit_sw, data_sw, greens_sw, \
                          noise_std_sw, cov_inv, log_cov_det, max_noise_parameter=400, M00=1.0e15, method='mij_correlated') 
    ...
    if comm.rank==0:
        ...
        plot_waveform_fit(best_mt.as_vector(), solver.obs, solver.greens, stations, noise_sol, tau_sol, event_id+'_Waveformfit_mean_covm.jpg', evdp_in_km)
