...
if __name__=='__main__':
    ...
    path_data=    fullpath('/Users/u7091895/Documents/Research/BayMTI/HiBaysin/data/20160106013000000/*.BH[ZRT].sac')
    path_weights= fullpath('/Users/u7091895/Documents/Research/BayMTI/HiBaysin/data/20160106013000000/weights_surf.dat')
    ...
    process_sw = ProcessData(
        ...
        CPS_database='/Users/u7091895/Documents/Research/BayMTI/HiBaysin/data/grn_2016a_2d/',
        CPS_model=model,
    ...
    origin = Origin({
        'time': '2016-01-06T01:30:00.000000Z',
        'latitude': 41.3001,
        'longitude': 129.0680,
        'depth_in_m': 500.,
        })
    ...
    if comm.rank==0:
        ...
        db = open_db('/Users/u7091895/Documents/Research/BayMTI/HiBaysin/data/grn_2016a_2d/mdj3',  format='CPS', model=model)
...
#         greens.convolve(wavelet)
        ...
        noise_estimator = covariace_matrix(origin, data_noise, npts_acf_lag, noise_length=1000, noise_model='uncorrelated')
    ...
    if comm.rank==0:
        ...
        solver = MCMC_SOLVER(misfit_sw, data_sw, greens_sw, \
                          noise_std_sw, max_noise_parameter=40, M00=1.0e13, method='mij_uncorrelated')
