...
if __name__=='__main__':
    ...
    path_weights= fullpath('/Users/u7091895/Documents/Research/BayMTI/HiBaysin/data/20160106013000000/weights.dat')
...
#         greens.convolve(wavelet)
    ...
    if comm.rank==0:
        ...
        solver = MCMC_SOLVER(misfit_sw, data_sw, greens_sw, \
                          noise_std_sw, max_noise_parameter=400, M00=5.0e13, method='mij_uncorrelated')
