...
#         greens.convolve(wavelet)
    ...
    if comm.rank==0:
        ...
        solver = MCMC_FullMij(misfit_sw, data_sw, greens_sw,
                          ...
                          max_noise_parameter=400, M00=1.e14, noise_type='correlated')
    ...
    if comm.rank==0:
        ...
        plot_waveform_fit(best_mt.as_vector(), solver.obs, solver.greens, stations, noise_sol, tau_sol, event_id+'Waveformfit_mean_Covm.jpg', delta=1, evdp_in_km=evdp_in_km)
