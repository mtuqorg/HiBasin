...
from hibasin.util.misfit_preparation import shift_data
...
if __name__=='__main__':
    ...
    path_data=    fullpath('data/20160909003001000/*.BH[ZRT].sac')
    path_weights= fullpath('data/20160909003001000/weights.dat')
