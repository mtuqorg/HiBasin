...
if __name__=='__main__':
    ...
    path_data=    '../data/20061009013528000/*.BH[ZRT].sac'
    path_weights= '../data/20061009013528000/weights_surf.dat'
    event_id=     '20061009013528000'
    model=        'mdj3'
    ...
    process_sw = ProcessData(
        ...
        CPS_database='../data/grn_2006_2d/mdj3/',
    ...
    if comm.rank==0:
        ...
        db = open_db('../data/grn_2006_2d/mdj3',  format='CPS', model=model)
        ...
        noise_estimator = covariance_matrix_Cd(origin, 
                                               data_noise, npts_acf_lag, process_sw, 
                                               noise_length=2000, 
    ...
    if comm.rank==0:
        ...
        solver = MCMC_FullMij(misfit_sw, data_sw, greens_sw,
                          noise_std_sw, max_noise_parameter=40, 
                          M00=1.e12, noise_type='uncorrelated')
    ...
    if comm.rank==0:
        ...
        plot_waveform_fit(best_mt.as_vector(), solver.obs, solver.greens, 
                          ...
                          event_id+'_Waveformfit_mean.jpg',delta=1, 
                          evdp_in_km=evdp_in_km)
