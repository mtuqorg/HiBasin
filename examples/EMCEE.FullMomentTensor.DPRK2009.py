...
if __name__=='__main__':
    ...
    path_data=    fullpath('data/20090525005443000/*.BH[ZRT].sac')
    path_weights= fullpath('data/20090525005443000/weights_surf.dat')
    ...
    if comm.rank==0:
        ...
        solver = MCMC_SOLVER(misfit_sw, data_sw, greens_sw, \
                          noise_std_sw, max_noise_parameter=400, M00=1.e13, method='mij_uncorrelated')
