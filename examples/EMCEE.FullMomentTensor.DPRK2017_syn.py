...
####
    ...
    if comm.rank==0:
        ...
        solver = MCMC_FullMij(misfit_sw, data_sw, greens_sw,
                          noise_std_sw, max_noise_parameter=400, M00=5.0e14, noise_type='uncorrelated')
    ...
    if comm.rank==0:
        ...
        posterior_distribution_mij(flat_samples_fname=solver.chain_fname,log_prob_fname=solver.logprob_fname, mt_degree=solver.ne, thin=10, ratio=0.5, figure_fname=event_id+"_Posterior_source_parameter.jpg")
