...
if __name__=='__main__':
    ...
    CPS_database= '../data/grn_2013_2d/mdj3/'
    ...
    #
    # Next, we specify source-time function
    #
    wavelet = Trapezoid(
        magnitude=4.5)
...
#         greens.convolve(wavelet)
    ...
    solver = MCMC_FullMij(misfit_sw, data_sw, greens_sw,
                        noise_std_sw, max_noise_parameter=40, M00=1.e14, noise_type='uncorrelated')
    ...
    plot_waveform_fit(best_mt.as_vector(), solver.obs, solver.greens, stations, noise_sol, tau_sol, event_id+'Waveformfit_mean.jpg', delta=1, evdp_in_km=evdp_in_km)
